<template>
  <div>
    <div class="text-center place-items-center">
      ...
      <img class="mx-auto mb-6" width="150" src="https://wedding-felipe-tatiana.s3.sa-east-1.amazonaws.com/rosa.png"
        alt="Seprador" title="Separador" height="270" sizes="sm:100vw md:100vw lg:100vw" />

      <p class="about-text text-space-10">Queridos familiares e amigos, para nós, a presença de vocês neste dia tão
        especial é o maior presente que poderíamos receber. </p>

      <p class="about-text text-space-10">Mas, se vocês também quiserem nos presentear, separamos algumas opções abaixo.
      </p>

      <p class="about-text text-space-10">Com amor, Tatiana e Felipe.</p>
    </div>
    ...
    <section
      ...
      <Product :items="products" @add-new-item="addItem($event)" @remove-item="emitRemoveItem($event)" />
    </section>
  </div>
</template>
