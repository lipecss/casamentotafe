      ...
      <div class="flex flex-wrap -mx-4">
        <div class="hidden md:block md:w-1/2 px-4">
          <div class="h-full w-full bg-cover shadow-md"
            style="background-image: url('https://wedding-felipe-tatiana.s3.sa-east-1.amazonaws.com/Pr%C3%A9+Wedding+Tatiana+e+Felipe-49.jpg')" />
        </div>
      ...
      <div class="flex flex-wrap -mx-4">
        ...
        <div class="hidden md:block md:w-1/2 px-4">
          <div class="h-full w-full bg-cover rounded shadow-md"
            style="background-image: url('https://wedding-felipe-tatiana.s3.sa-east-1.amazonaws.com/Pr%C3%A9+Wedding+Tatiana+e+Felipe-53.jpg')">
          </div>
        </div>
      </div>
    </section>
